...
import cn.edu.cug.cs.gtl.data.sdb.beam.feature.BeamFeatureReader;
...
import cn.edu.cug.cs.gtl.filter.EnvelopeContainsFeatureFilter;
import cn.edu.cug.cs.gtl.filter.FeatureFilter;
...
/**
 * 输入矩形边界，进行查询
 * mvn package exec:java -Dexec.mainClass=Querier
 * -Dexec.args="
 ...
 * mvn package exec:java -Dexec.mainClass=Querier -Dexec.args=" --inputFile=/home/vincent/gtl/data/dat/counties/county_small.tsv --outputFile=/home/vincent/gtl/data/dat/temp/county_small.analyzer --minX=-130.0 --minY=-100.0 --maxX=30.0 --maxY=50.0 --runner=FlinkRunner" -Pflink-runner
 * $FLINK_HOME/bin/flink run -c Querier ./target/geobeam-bundled-1.0-SNAPSHOT.jar  --inputFile=/home/vincent/gtl/data/dat/counties/county_small.tsv --outputFile=/home/vincent/gtl/data/dat/temp/county_small.querier --minX=-130.0 --minY=-100.0 --maxX=30.0 --maxY=50.0 --runner=FlinkRunner
 */
